...
from brain_datasets import create_stage2_dataloader, get_split_statistics
from hierarchical_adapter_mvp_llama import SemanticAlignmentAdapter, SubjectInvariantAdapter
...
class Stage2Trainer:
    ...
    def train_epoch(self, epoch: int):
        ...
        for batch in pbar:
            ...
            if self.config.stage2_training.use_semantic_consistency:
                ...
                consistency_loss = self.consistency_loss_fn(
                    semantic_feature, next_semantic_feature
                )
        ...
        return {
            ...
            'alignment_loss': total_alignment / n_batches,
    ...
    def train(self):
        for epoch in range(1, self.config.stage2_training.num_epochs + 1):
            ...
            if epoch % self.config.stage2_training.save_every_n_epochs == 0 or is_best:
